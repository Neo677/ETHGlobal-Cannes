...
import { CarteGriseViewer } from '@/components/3D/CarteGriseViewer';
...
// --- Ajout du formulaire de mint NFT public/privé ---
import { SellerMintForm } from './SellerMintForm';
// ...

// Dans le return, juste avant la fin du composant :
// (par exemple, juste après le header ou avant le listing des véhicules)
<SellerMintForm />
