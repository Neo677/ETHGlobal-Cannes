...
# Define a class to store car and owner information, identified by NFT token
class CarData:
    def __init__(self, nft_token, name, vin, history, location, address, car_model,
                 years_licensed, violations, claims):
        ...
        self.years_licensed = years_licensed    # Years the owner has held a license
        self.violations = violations            # Number of traffic violations
        self.claims = claims                    # Number of insurance claims
